/*
	easychain transactions API calls
 */
 ...
 * @param {Transactions~getTransactionsCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Transactions~getTransaction} cb - Callback handles response from easychain.
 */
 ...
 * @param {Transactions~getUnconfirmedTransaction} cb - Callback handles response from easychain.
 */
 ...
 * @param {Transactions~getUnconfirmedTransactions} cb - Callback handles response from easychain.
 */
 ...
 * @param {Transactions~addTransactionsCallback} cb - Callback handles response from easychain.
 */
