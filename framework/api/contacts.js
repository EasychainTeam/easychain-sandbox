 ...
 * @param {Contacts~getContactsCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Contacts~addContactCallback} cb - Callback handles response from easychain
 */
 ...
 * @param {Contacts~getFeeCallback} cb - Callback handles response from easychain.
 */
