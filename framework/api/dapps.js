 ...
 * @param {Dapps~getGenesisCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Dapps~sendWithdrawal} cb - Callback handles response from easychain.
 */
 ...
 * @param cb - Callback handles response from easychain.
 */
 ...
 * @param {Dapps~setReadyCallback} cb - Callback handles response from easychain.
 */
