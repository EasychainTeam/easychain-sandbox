 ...
 *
 * @param id - Block id.
 * @param {Blocks~blockCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Blocks~getBlocksCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Blocks~getHeightCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Blocks~getFeeCallback} cb - Callback handles response from easychain.
 */
