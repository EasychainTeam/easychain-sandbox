 ...
 * @param {Sql~selectCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Sql~insertCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Sql~batchCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Sql~updateCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Sql~removeCallback} cb - Callback handles response from easychain.
 */
