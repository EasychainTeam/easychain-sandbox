...
/**
 * Open account in easychain.
 *
 * @param secret - Secret of account.
 * @param {Accounts~openCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Accounts~balanceCallback} cb - Callback handle response from easychain.
 */
 ...
 * @param address - Address of account.
 * @param {Accounts~publicKeyCallback} cb - Callback handle response from easychain.
 */
 ...
 *
 * @param address - Address of account.
 * @param {Accounts~delegatesCallback} cb - Callback handle response from easychain.
 */
