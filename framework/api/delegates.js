 ...
 * @param {Delegates~getDelegateCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Delegates~getDelegatesCallback} cb - Callback handles response from easychain.
 */
 ...
 *
 * @param {Delegates~getFeeCallback} cb - Callback handles response from easychain.
 */
 ...
 * @param {Delegates~getForgedByAccount} cb - Callback handles response from easychain.
 */
 ...
 * @param error - Error of api call execution.
 * @param response - Response of api call execution.
 * @param response.fees - Amount of easychain that delegate forged.
 */
 ...
 * @param {Delegates~addDelegate} cb - Callback handles response from easychain.
 */
